...
export default function Projects() {
  ...
  const projects = [
    ...
    {
      title: 'Staicey – AI Hotel Travel Assistant',
      subtitle: 'Conversational AI-Powered Hotel Recommendation System',
      summary: 'Full-stack AI travel concierge that turns natural-language requests into real-time, ranked hotel recommendations',
      description: [
        'Built a ChatGPT-style multi-tab travel assistant with SSE streaming and live progress UX',
        'Integrated LangChain tool-calling agent with SerpAPI, Tavily, and Pinecone for multi-source hotel discovery',
        'Engineered async parallel agent architecture reducing query latency by ~50–68% on multi-hotel searches',
        'Implemented hybrid Redis + MongoDB memory for fast session handling and persistent chat history',
        'Designed guest funnel with Redis-backed rate limiting (3 searches/day) and conversion-focused signup prompts',
        'Deployed FastAPI backend on Fly.io (Sydney) with Docker, MongoDB Atlas, and Redis Cloud',
      ],
      problem: 'Travelers waste time jumping between Booking.com, Google Hotels, review sites, and maps to find the right hotel — traditional search cannot interpret nuanced preferences like "quiet boutique near the beach, pet-friendly, under $200".',
      solution: 'Built Staicey, a conversational AI hotel concierge powered by GPT and LangChain agents that interprets natural-language travel requests, searches multiple real-time sources in parallel, generates AI-written hotel notes, and streams rich results (ratings, pricing, amenities, maps, booking links) directly into a modern chat interface.',
      results: [
        '~50–68% reduction in end-to-end response latency via async parallel tool execution',
        'Multi-hotel queries reduced from ~5300 ms to ~1700 ms in benchmarks',
        'Guest-to-user conversion funnel with rate limiting and seamless signup prompts',
        'Real-time SSE streaming with granular progress phases ("Searching Google Hotels…")',
        'Full multi-tab persistent chat with per-session hotel search history',
      ],
      tech: [
        'Python', 'FastAPI', 'LangChain', 'LangGraph', 'OpenAI GPT',
        'MongoDB', 'Redis', 'Motor', 'SerpAPI', 'Tavily',
        'Next.js 14', 'React', 'TypeScript', 'Tailwind CSS',
        'Framer Motion', 'Docker', 'Fly.io', 'JWT', 'SSE',
      ],
      github: 'https://github.com/daksh-025/AI-travel-agent',
      pdfUrl: '/travelagent-pdf.pdf',
      color: '#2EA3FF',
      icon: '🏨',
    },
  ];
